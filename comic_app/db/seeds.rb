...
user1= User.create(username: "Bchan", first_name: "Brian", last_name: "Gabot", age: 26, email: "bgabot89@gmail.com", password: "password", person: "Artist", sex: "Male", about: "Hi I like to draw anime stuff", tech: "Softwares: Adobe Photoshop, Illustrator, Painttool Sai. Techs: Pencil, Pen, Mouse, Wacom Tablet", avatar_file_name: "/images/brian.png")
